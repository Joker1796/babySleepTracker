...
export const ADVISOR_RULES = [
  ...
  },
  {
    ...
    tipId: 'overtired',
    text: c => `Сильный перегул: ${Math.round(-c.wakeWindowLeft)} мин сверх окна бодрствования. Ребёнок может быть перевозбуждён и сопротивляться сну. Сначала успокойте (затемните комнату, возьмите на руки, пошипите монотонно «шшш»), затем укладывайте.`
  },
  {
    id: 'short-nap',
    priority: 2,
  ...
  },
  {
    ...
    text: () => 'Ночной сон идёт. Для крепкой ночи: полная темнота (блэкаут-шторы сильно помогают), 18–22 °C, проветренная комната. При пробуждениях — минимум света, тихий голос, никакой стимуляции.'
  }
]
