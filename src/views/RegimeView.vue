...
<template>
  <div class="page">
    ...
    <template v-else>
      ...
      <p class="muted small footnote">Значения переопределяют возрастные нормы: прогноз следующего сна, фазы «скоро сон / пора укладывать» и оценка суточной нормы считаются по ним. Чтобы вернуться к авторасчёту, переключите режим на экране «Настройки».</p>
    </template>
  </div>
</template>
