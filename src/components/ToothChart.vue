...
<template>
  <div class="tooth-chart">
    <svg viewBox="0 0 300 150" class="tc-svg" role="group" aria-label="Схема молочных зубов">
...
.tc-tooth:focus { outline: none; }
.tc-tooth:focus-visible rect { stroke: var(--c-accent); stroke-width: 2; }

.tc-hint { margin: var(--sp-2) 0 0; }
</style>
